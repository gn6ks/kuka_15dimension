...
%
blkStruct.Name = ['Visual Servoing'];

%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'vs';
...
%
Browser(1).Library = 'vs';
Browser(1).Name    = 'Visual Servoing';
Browser(1).IsFlat  = 0;% Is this library "flat" (i.e. no subsystems)?

% Browser(2).Library = 'Features';
% Browser(2).Name    = 'Features';
% Browser(2).IsFlat  = 0;% Is this library "flat" (i.e. no subsystems)?

% Browser(3).Library = 'Camera';
% Browser(3).Name    = 'Camera';
% Browser(3).IsFlat  = 0;% Is this library "flat" (i.e. no subsystems)?

% Browser(4).Library = 'Jacobian';
% Browser(4).Name    = 'Jacobian';
