...
legend('ref pos q_0', 'real pos q_0');
...
legend('ref pos q_1','ref pos q_2', 'real pos q_1','real pos q_2');
...
%'Location','southwest'
legend('acc ctrl q_1','acc ctrl q_2');
...
legend('ref vel q_0', 'real vel q_0');
...
legend('ref vel q_1', 'ref vel q_2','real vel q_1','real vel q_2');
...
legend('ref acel q_0', 'real acel q_0');
...
legend('ref acel q_1', 'ref acel q_2','real acel q_1','real acel q_2');
